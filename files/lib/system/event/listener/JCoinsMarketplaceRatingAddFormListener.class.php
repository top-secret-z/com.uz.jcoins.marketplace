...
/**
 * Checks whether the user has enough JCoins to add a new marketplace rating.
 */
class JCoinsMarketplaceRatingAddFormListener implements IParameterizedEventListener
{
    /**
     * @inheritdoc
     */
    public function execute($eventObj, $className, $eventName, array &$parameters)
    {
        ...
        $statement = UserJCoinsStatementHandler::getInstance()->getStatementProcessorInstance('com.uz.jcoins.statement.marketplace.rating');
